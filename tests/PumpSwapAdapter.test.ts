...
describe('PumpSwapAdapter', () => {
  ...
  it('should return signature on buy', async () => {
    ...
    expect(signature).toBe('pumpswap_buy_signature');
  });
  ...
  it('should return signature on sell', async () => {
    ...
    expect(typeof signature).toBe('string');
    expect(signature).toBe('pumpswap_sell_signature');
  });
  ...
  it('should return signature on swap', async () => {
    ...
    expect(typeof signature).toBe('string');
    expect(signature).toBe('pumpswap_swap_signature');
  });
